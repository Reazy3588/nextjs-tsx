...
import { addToCard, removeFromCart } from "@/redux/features/cart/cartSlice";




export default function CardProduct ({title, image, price, onClick, id}: cartProductType) {
  ...
  <div className="flex flex-1 flex-col px-4 py-6">
    ...
    <div className="mt-auto flex items-end justify-between">
      <div className="flex flex-col">
        ...
        <button onClick={() => dispatch(addToCard({id, title, image, price}))}  className=" cursor-pointer group relative inline-flex h-12 items-center justify-center overflow-hidden rounded-xl bg-cyan-600 px-8 font-bold text-white transition-all duration-300 hover:bg-cyan-500 hover:shadow-[0_0_20px_rgba(8,145,178,0.4)] active:scale-95">
